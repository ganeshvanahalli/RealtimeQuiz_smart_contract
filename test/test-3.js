...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////    
    ...
    it("tests that player 4 registers", async () => {
      await quiz.register({from: accounts[4], value: pFee});
      let val1 = await quiz.playerExists(accounts[4]);
      assert.equal(val1, true, "player isn't registered");

    });

    it("tests that player 5 registers", async () => {
      await quiz.register({from: accounts[5], value: pFee});
      let val1 = await quiz.playerExists(accounts[5]);
      assert.equal(val1, true, "player isn't registered");

    });

    it("tests that player 6 registers", async () => {
      await quiz.register({from: accounts[6], value: pFee});
      let val1 = await quiz.playerExists(accounts[6]);
      assert.equal(val1, true, "player isn't registered");

    });

    it("tests that player 7 registers", async () => {
      await quiz.register({from: accounts[7], value: pFee});
      let val1 = await quiz.playerExists(accounts[7]);
      assert.equal(val1, true, "player isn't registered");

    });

    it("tests that player 8 registers", async () => {
      await quiz.register({from: accounts[8], value: pFee});
      let val1 = await quiz.playerExists(accounts[8]);
      assert.equal(val1, true, "player isn't registered");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
    it("tests that player 9 who didnt register is not there", async () => {
      let val1 = await quiz.playerExists(accounts[9]);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    it("tests that player 4 doesnt get the question before start time", async () => {
      let val1 = await quiz.getQuestion({from: accounts[4]});
      assert.equal(val1, "Sorry!! quiz ended", "player gets the question before start time");
    });
    
    it("tests that player 5 doesnt get the question before start time", async () => {
      let val1 = await quiz.getQuestion({from: accounts[5]});
      assert.equal(val1, "Sorry!! quiz ended", "player gets the question before start time");
    });

    it("tests that player 6 doesnt get the question before start time", async () => {
      let val1 = await quiz.getQuestion({from: accounts[6]});
      assert.equal(val1, "Sorry!! quiz ended", "player gets the question before start time");
    });
    
    it("tests that player 7 doesnt get the question before start time", async () => {
      let val1 = await quiz.getQuestion({from: accounts[7]});
      assert.equal(val1, "Sorry!! quiz ended", "player gets the question before start time");
    });
    
    it("tests that player 8 doesnt get the question before start time", async () => {
      let val1 = await quiz.getQuestion({from: accounts[8]});
      assert.equal(val1, "Sorry!! quiz ended", "player gets the question before start time");
    });
